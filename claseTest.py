...
class TestVehiculos(unittest.TestCase):
    ...
    def test_insertarElemento1(self):
        ...
        print("Resultado del assert1 : {} == {} = {}".format("Blanco", self.__vehiculos.mostrarColor(posicion),self.assertEqual("Blanco", self.__vehiculos.mostrarColor(posicion))))
    ...
    def test_insertarElemento2(self):
        ...
        #self.assertEqual(vehiculo, self.__vehiculos.mostrarElemento(posicion))
        print("Resultado del assert2 : {} == {} = {}".format("Negro", self.__vehiculos.mostrarColor(posicion),self.assertEqual("Negro", self.__vehiculos.mostrarColor(posicion))))
    ...
    def test_insertarElemento3(self):
        ...
        #self.assertEqual(vehiculo, self.__vehiculos.mostrarElemento(posicion))
        print("Resultado del assert3 : {} == {} = {}".format("Gris", self.__vehiculos.mostrarColor(posicion),self.assertEqual("Gris", self.__vehiculos.mostrarColor(posicion))))
